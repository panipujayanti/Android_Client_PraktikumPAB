...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UserViewHolder holder, int position) {
        ...
        holder.progstud.setText(user.getProgstud());
        holder.email.setText(user.getEmail());
        holder.alamat.setText(user.getAlamat());
        holder.tanggal_lahir.setText(user.getTanggalLahir());
        holder.jenis_kelamin.setText(user.getJenisKelamin());
    ...
    public class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView NIM, name, progstud, email, alamat, tanggal_lahir, jenis_kelamin;
        ...
        public UserViewHolder(View itemView) {
            ...
            progstud = itemView.findViewById(R.id.textViewProgstud);
            alamat = itemView.findViewById(R.id.textViewAlamat);
            tanggal_lahir = itemView.findViewById(R.id.textViewTanggalLahir);
            jenis_kelamin= itemView.findViewById(R.id.textViewJenisKelamin);
